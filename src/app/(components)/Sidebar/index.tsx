...
import { Archive, CircleDollarSign, Clipboard, icons, Layout, LucideIcon, Menu, SlidersHorizontal, User } from 'lucide-react';
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
        <div>logo</div>
        <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>Matador</h1>
      <button 
